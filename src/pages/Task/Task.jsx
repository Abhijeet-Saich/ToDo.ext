...
const Task = () => {
  ...
  const {time,name,task,message,textQuote,browserDispatch} = useBrowser();
  ...
  return (
    <div className="task-container d-flex direction-column align-center task-glass">
      <Weather />
      ...
      {name !== null && task === null ? (
        ...
        <div className="user-task-container d-flex direction-column align-center gap">
          ...
          <div className="d-flex align-center justify-center">
            <input type="checkbox" checked={isChecked} className="task-check" id="input-check" onChange={handleCompleteTaskChange}/>
            <label for="input-check" className={isChecked ? "heading-3 label strike-through" : "heading-3 label"}>
              {task}
            </label>
      ...
      <div className="quote-container absolute bottom-0 d-flex align-center justify-center glass-quote">
